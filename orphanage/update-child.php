...
include_once('../libs/ChildValidation.php'); 

$res = $home->orphan([$_GET['orphanid']]);
?>
<!doctype html>
<html lang="en">
  <head>
       ...
       <?php if (isset($error)) { ?>
                     ...
                     <form method="post" action="" enctype="multipart/form-data">
                            <div class="form-group">
                                   ...
                                   <input type="text" name="name" id="name" value="<?php echo $res->name; ?>" class="form-control input-sm" placeholder="Orphan Name">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="submit" value="Save" name="update" class="btn btn-info btn-block">
		       </form>
	</div>
        </div>
      </div>

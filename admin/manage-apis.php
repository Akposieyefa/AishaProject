...
die($secretKey);
$sql="update tbl_admin set PaymentSecretKey=:secretKey,PaymentPublicKey=:PaymentPublicKey where UserName:user";
...
<head>
	...
	<title>Orphanage Central System | Admin Manage Api</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<?php $sql = $dbh ->query("SELECT PaymentSecretKey, PaymentPublicKey FROM tbl_admin");
  if($sql->rowCount() > 0)
{
